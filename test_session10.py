	...
	def test_blood_type_named_tuple():
	    ...
	    for p in nt_profiles:
	        counter[p[1]] += 1
	    assert counter.most_common(1)[0][0] == main.blood_type_named_tuple(nt_profiles),\
	...
	def test_blood_type_dictionary():
	    ...
	    assert counter.most_common(1)[0][0] == main.blood_type_dictionary(dict_profiles),\
	...
	def test_mean_location_named_tuple():
	    ...
	    mean_loc[0]/num, mean_loc[1]/num == main.oldest_age_named_tuple(nt_profiles),\
	...
	def test_mean_location_dictionary():
	    ...
	    mean_loc[0]/num, mean_loc[1]/num == main.mean_location_dictionary(dict_profiles),\
	...
	def test_oldest_age_dictionary():
	    ...
	    assert max_age_prof['age'] == main.oldest_age_dictionary(dict_profiles),\
	...
	def test_oldest_age_named_tuple():
	    ...
	    assert age == main.oldest_age_named_tuple(nt_profiles),\
	...
	def test_average_age_named_tuple():
	    ...
	    assert avg_age == main.average_age_named_tuple(nt_profiles),\
	...
	def test_average_age_dictionary():
	    ...
	    assert avg_age == main.average_age_dictionary(dict_profiles),\
